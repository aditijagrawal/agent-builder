...
import RHSPanelHeader from '../../RHSPanelHeader/RHSPanelHeader';
import RHSPanelFooter from '../../RHSPanelFooter/RHSPanelFooter';
...
export default function ScheduleBased({
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1, overflowY: 'auto', padding: '16px 15px', boxSizing: 'border-box',
