...
import CloseIcon from '../RHSSidePanelHeader/icons/close.svg';
...
export default function RHSSidePanelFooter({
  onSave,
  saveLabel = 'Save',
  disabled = false,
  ...
  const strengthColor = {
    Weak: '#de1b0c',    // semantic/negative — Elemental red
    Medium: '#fbc123',  // yellow90 — Elemental warning yellow
    Strong: '#49a830',  // greenS — Elemental success green
  ...
  return (
    <div style={{
      ...
      {/* Suggestions panel — expands upward */}
      ...
      {/* Prompt strength — only for LLM task RHS */}
      {showPromptStrength && (
        <PromptStrengthBar
